...
MyScintillation::MyScintillation(G4double aTemperature,
				 G4double aActivation,
...
//....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo......
MyScintillation::~MyScintillation()
{
...
//....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo......
void MyScintillation::ProcessDescription(std::ostream& out) const
{
...
//....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo......
G4bool MyScintillation::IsApplicable(const G4ParticleDefinition& aParticleType)
{
...
//....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo......
void MyScintillation::PreparePhysicsTable(const G4ParticleDefinition&)
{
  Initialise();
}

//....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo......
void MyScintillation::Initialise()
{
  G4OpticalParameters* params = G4OpticalParameters::Instance();
...
//....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo......
void MyScintillation::BuildPhysicsTable(const G4ParticleDefinition&)
{
  if(fIntegralTable1 != nullptr)
  {
    fIntegralTable1->clearAndDestroy();
...
//....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo......
G4VParticleChange* MyScintillation::AtRestDoIt(const G4Track& aTrack,
                                               const G4Step& aStep)
// This routine simply calls the equivalent PostStepDoIt since all the
// necessary information resides in aStep.GetTotalEnergyDeposit()
{
  return MyScintillation::PostStepDoIt(aTrack, aStep);
}

//....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo......
G4VParticleChange* MyScintillation::PostStepDoIt(const G4Track& aTrack,
                                                 const G4Step& aStep)
...
// ------------------------------------------------------
  ...
  // G4double activation_energy = 15000;  // J/Mole, which decides the rate of degradation. Which is guessed.
  // scale facotr is restricted by the fact that quenching probability approaches unity when temperature marching 375 celcius degree
  G4double scale_factor = G4Exp(Activation/(K*(thermal_T+quenching_celcius)));  // which decides the magnitude of thermal quenching rate
  // G4double current_celcius = 25;

  G4double quenching_probability = scale_factor*G4Exp(-Activation/(K*(thermal_T+Temperature)));  // 0.038 at 25 celcius. 0.51 at 250 celcius
  fNumPhotons *= 1-quenching_probability;
// -------------------------------------------------------
// --------------[ Finished ] ------------------------
// -------------------------------------------------------
...
//....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo......
G4double MyScintillation::GetMeanFreePath(const G4Track&, G4double,
...
//....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo......
G4double MyScintillation::GetMeanLifeTime(const G4Track&,
                                          G4ForceCondition* condition)
{
  *condition = Forced;
  return DBL_MAX;
...
//....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo......
G4double MyScintillation::sample_time(G4double tau1, G4double tau2)
{
...
//....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo......
G4double MyScintillation::GetScintillationYieldByParticleType(
...
//....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo......
void MyScintillation::DumpPhysicsTable() const
{
  if(fIntegralTable1)
  {
...
//....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo......
void MyScintillation::SetTrackSecondariesFirst(const G4bool state)
{
...
//....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo......
void MyScintillation::SetFiniteRiseTime(const G4bool state)
{
...
//....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo......
void MyScintillation::SetScintillationByParticleType(const G4bool scintType)
{
...
//....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo......
void MyScintillation::SetScintillationTrackInfo(const G4bool trackType)
{
...
//....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo......
void MyScintillation::SetStackPhotons(const G4bool stackingFlag)
{
...
//....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo......
void MyScintillation::SetVerboseLevel(G4int verbose)
{
