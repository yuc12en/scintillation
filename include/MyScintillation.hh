...
class MyScintillation : public G4VRestDiscreteProcess
{
 public:
  explicit MyScintillation(G4double aTemperature,
			   G4double aActivation,
			   const G4String& processName = "Scintillation",
                           G4ProcessType type          = fElectromagnetic);
  ~MyScintillation();

  MyScintillation(const MyScintillation& right) = delete;
  MyScintillation& operator=(const MyScintillation& right) = delete;
...
inline G4bool MyScintillation::GetTrackSecondariesFirst() const
{
  return fTrackSecondariesFirst;
}

inline G4bool MyScintillation::GetFiniteRiseTime() const
{
  return fFiniteRiseTime;
}

inline G4PhysicsTable* MyScintillation::GetIntegralTable1() const
{
  return fIntegralTable1;
}

inline G4PhysicsTable* MyScintillation::GetIntegralTable2() const
{
  return fIntegralTable2;
}

inline G4PhysicsTable* MyScintillation::GetIntegralTable3() const
{
  return fIntegralTable3;
}

inline void MyScintillation::AddSaturation(G4EmSaturation* sat)
{
  fEmSaturation = sat;
}

inline void MyScintillation::RemoveSaturation() { fEmSaturation = nullptr; }

inline G4EmSaturation* MyScintillation::GetSaturation() const
{
  return fEmSaturation;
}

inline G4bool MyScintillation::GetScintillationByParticleType() const
{
  return fScintillationByParticleType;
}

inline G4bool MyScintillation::GetScintillationTrackInfo() const
{
  return fScintillationTrackInfo;
}

inline G4bool MyScintillation::GetStackPhotons() const { return fStackingFlag; }

inline G4int MyScintillation::GetNumPhotons() const { return fNumPhotons; }

inline G4double MyScintillation::single_exp(G4double t, G4double tau2)
{
  return std::exp(-1.0 * t / tau2) / tau2;
}

inline G4double MyScintillation::bi_exp(G4double t, G4double tau1,
                                        G4double tau2)
{
